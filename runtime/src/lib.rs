...
pub use frame_support::{
	...
	traits::{
		...
		EqualPrivilegeOnly, EitherOfDiverse
	},
	weights::{
		constants::{
...
pub use frame_system::{EnsureRoot, EnsureWithSuccess};
...
impl pallet_democracy::Config for Runtime {
	...
	// Root must agree.
	type CancelProposalOrigin = pallet_collective::EnsureProportionAtLeast<AccountId, CouncilCollective, 1, 1>;
...
parameter_types! {
	...
	pub const TreasuryPalletId: PalletId = PalletId(*b"otp/cmtr");
